...
Enquanto o cálculo-$\lambda$ define sua semântica operacional por meio das regras de redução $\beta$ e $\eta$, o \textit{CPS-calculus} possui uma teoria equacional própria, formulada em \citeonline{thielecke1997categorical}.
