...
O sistema de tipos de Damas e Milner conta com um conjunto de regras de inferência de tipos, apresentados na Figura \ref{eq:type-inference}, possíveis de serem utilizados nas expressões deste mesmo sistema.
As ditas regras são julgamentos de tipos como este: $\Gamma \vdash e: \sigma $, onde $\Gamma$ é o contexto, um conjunto de suposições com duplas de variáveis e seus tipos: $(e,\ \sigma)$, $e$ é a expressão sendo inferida e o tipo desta é $\sigma$ no contexto.
...
A seguir, será apresentado o Algoritmo W para inferência de tipos neste sistema.
