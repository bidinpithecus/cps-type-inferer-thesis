...
Um exemplo de tipo simples é uma função em Haskell que opera sobre números inteiros.
...
% Especificar e como ele se relaciona com a inferência de tipos:
