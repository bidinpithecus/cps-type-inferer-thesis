...
Este trabalho tem como objetivo formalizar uma extensão para o sistema de tipos para CPS proposto por~\citeonline{thielecke1997categorical}, adicionando polimorfismo com suporte a inferência para esta representação intermediária.
