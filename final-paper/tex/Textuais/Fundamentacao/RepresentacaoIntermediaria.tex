...
Vale ressaltar que \citeonline{appel1997shrinking} possuem uma sintaxe diferente para o cálculo de continuações, onde os termos são respectivamente representados como $k(\vv{x})$ e $\texttt{let }k(\vv{x}) = c \texttt{ in } b$.
