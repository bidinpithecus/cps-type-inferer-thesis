\begin{frame}{Efeitos Colaterais}
    \begin{itemize}
        \item \citeonline{mitchell_2002} define um efeito colateral (do inglês, \textit{side effect}) como mudanças visíveis no estado da máquina como resultado da valoração de uma expressão.
