...
\begin{equation}\label{eq:dm-syntax}\nonumber
  \begin{array}{ll}
    ...
    \alpha                                                                                                       \\
    \text{Schemes}           & \sigma \Coloneqq \forall \alpha. \sigma \mid \tau                                       \\
  \end{array}
\end{equation}
...
O algoritmo de unificação, \Unify, descrito na Figura~\ref{algo:unify}, gera a unificação mais geral possível, operando recursivamente sobre a estrutura dos tipos.
