...
Ao se traduzir o numeral de Church 0 representado em cálculo-$\lambda$ por $\lambda f.\lambda x.\ x$, para CBN, tem-se:
\lstinputlisting[style=boxless-haskell]{Code/Type-Inferer/CPS/church-zero-cbn.cps}
E semelhantemente, para CBV:
\lstinputlisting[style=boxless-haskell]{Code/Type-Inferer/CPS/church-zero-cbv.cps}
